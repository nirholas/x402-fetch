...
// requirements. A compliant x402 merchant emits the v2 envelope both as the JSON
// body and as the base64 `PAYMENT-REQUIRED` response header; we read the header
// first (it survives an already-consumed body and a non-JSON content-type) and
